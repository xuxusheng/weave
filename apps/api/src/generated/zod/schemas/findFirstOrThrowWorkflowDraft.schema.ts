...
export const WorkflowDraftFindFirstOrThrowSelectSchema: z.ZodType<Prisma.WorkflowDraftSelect> = z.object({
...
export const WorkflowDraftFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    workflowId: z.boolean().optional(),
    nodes: z.boolean().optional(),
    edges: z.boolean().optional(),
...
export const WorkflowDraftFindFirstOrThrowSchema: z.ZodType<Prisma.WorkflowDraftFindFirstOrThrowArgs> = z.object({ select: WorkflowDraftFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([WorkflowDraftOrderByWithRelationInputObjectSchema, WorkflowDraftOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowDraftWhereInputObjectSchema.optional(), cursor: WorkflowDraftWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowDraftScalarFieldEnumSchema, WorkflowDraftScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkflowDraftFindFirstOrThrowArgs>;

export const WorkflowDraftFindFirstOrThrowZodSchema = z.object({ select: WorkflowDraftFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([WorkflowDraftOrderByWithRelationInputObjectSchema, WorkflowDraftOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowDraftWhereInputObjectSchema.optional(), cursor: WorkflowDraftWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowDraftScalarFieldEnumSchema, WorkflowDraftScalarFieldEnumSchema.array()]).optional() }).strict();