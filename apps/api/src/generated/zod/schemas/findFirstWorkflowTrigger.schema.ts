...
export const WorkflowTriggerFindFirstSelectSchema: z.ZodType<Prisma.WorkflowTriggerSelect> = z.object({
...
export const WorkflowTriggerFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    workflowId: z.boolean().optional(),
    name: z.boolean().optional(),
    type: z.boolean().optional(),
...
export const WorkflowTriggerFindFirstSchema: z.ZodType<Prisma.WorkflowTriggerFindFirstArgs> = z.object({ select: WorkflowTriggerFindFirstSelectSchema.optional(),  orderBy: z.union([WorkflowTriggerOrderByWithRelationInputObjectSchema, WorkflowTriggerOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowTriggerWhereInputObjectSchema.optional(), cursor: WorkflowTriggerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowTriggerScalarFieldEnumSchema, WorkflowTriggerScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkflowTriggerFindFirstArgs>;

export const WorkflowTriggerFindFirstZodSchema = z.object({ select: WorkflowTriggerFindFirstSelectSchema.optional(),  orderBy: z.union([WorkflowTriggerOrderByWithRelationInputObjectSchema, WorkflowTriggerOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowTriggerWhereInputObjectSchema.optional(), cursor: WorkflowTriggerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowTriggerScalarFieldEnumSchema, WorkflowTriggerScalarFieldEnumSchema.array()]).optional() }).strict();