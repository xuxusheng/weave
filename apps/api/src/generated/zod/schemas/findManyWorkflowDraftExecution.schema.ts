...
export const WorkflowDraftExecutionFindManySelectSchema: z.ZodType<Prisma.WorkflowDraftExecutionSelect> = z.object({
...
export const WorkflowDraftExecutionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    workflowId: z.boolean().optional(),
    kestraExecId: z.boolean().optional(),
    nodes: z.boolean().optional(),
...
export const WorkflowDraftExecutionFindManySchema: z.ZodType<Prisma.WorkflowDraftExecutionFindManyArgs> = z.object({ select: WorkflowDraftExecutionFindManySelectSchema.optional(),  orderBy: z.union([WorkflowDraftExecutionOrderByWithRelationInputObjectSchema, WorkflowDraftExecutionOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowDraftExecutionWhereInputObjectSchema.optional(), cursor: WorkflowDraftExecutionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowDraftExecutionScalarFieldEnumSchema, WorkflowDraftExecutionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkflowDraftExecutionFindManyArgs>;

export const WorkflowDraftExecutionFindManyZodSchema = z.object({ select: WorkflowDraftExecutionFindManySelectSchema.optional(),  orderBy: z.union([WorkflowDraftExecutionOrderByWithRelationInputObjectSchema, WorkflowDraftExecutionOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowDraftExecutionWhereInputObjectSchema.optional(), cursor: WorkflowDraftExecutionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowDraftExecutionScalarFieldEnumSchema, WorkflowDraftExecutionScalarFieldEnumSchema.array()]).optional() }).strict();