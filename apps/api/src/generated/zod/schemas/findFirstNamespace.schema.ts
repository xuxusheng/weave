...
export const NamespaceFindFirstSelectSchema: z.ZodType<Prisma.NamespaceSelect> = z.object({
...
export const NamespaceFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    kestraNamespace: z.boolean().optional(),
    description: z.boolean().optional(),
