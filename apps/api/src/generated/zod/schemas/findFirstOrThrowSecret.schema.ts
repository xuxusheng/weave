...
export const SecretFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SecretSelect> = z.object({
...
export const SecretFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    namespaceId: z.boolean().optional(),
    key: z.boolean().optional(),
    value: z.boolean().optional(),
...
export const SecretFindFirstOrThrowSchema: z.ZodType<Prisma.SecretFindFirstOrThrowArgs> = z.object({ select: SecretFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([SecretOrderByWithRelationInputObjectSchema, SecretOrderByWithRelationInputObjectSchema.array()]).optional(), where: SecretWhereInputObjectSchema.optional(), cursor: SecretWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SecretScalarFieldEnumSchema, SecretScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SecretFindFirstOrThrowArgs>;

export const SecretFindFirstOrThrowZodSchema = z.object({ select: SecretFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([SecretOrderByWithRelationInputObjectSchema, SecretOrderByWithRelationInputObjectSchema.array()]).optional(), where: SecretWhereInputObjectSchema.optional(), cursor: SecretWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SecretScalarFieldEnumSchema, SecretScalarFieldEnumSchema.array()]).optional() }).strict();