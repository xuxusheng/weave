...
export const WorkflowDraftExecutionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.WorkflowDraftExecutionSelect> = z.object({
...
export const WorkflowDraftExecutionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    workflowId: z.boolean().optional(),
    kestraExecId: z.boolean().optional(),
    nodes: z.boolean().optional(),
...
export const WorkflowDraftExecutionFindFirstOrThrowSchema: z.ZodType<Prisma.WorkflowDraftExecutionFindFirstOrThrowArgs> = z.object({ select: WorkflowDraftExecutionFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([WorkflowDraftExecutionOrderByWithRelationInputObjectSchema, WorkflowDraftExecutionOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowDraftExecutionWhereInputObjectSchema.optional(), cursor: WorkflowDraftExecutionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowDraftExecutionScalarFieldEnumSchema, WorkflowDraftExecutionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkflowDraftExecutionFindFirstOrThrowArgs>;

export const WorkflowDraftExecutionFindFirstOrThrowZodSchema = z.object({ select: WorkflowDraftExecutionFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([WorkflowDraftExecutionOrderByWithRelationInputObjectSchema, WorkflowDraftExecutionOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkflowDraftExecutionWhereInputObjectSchema.optional(), cursor: WorkflowDraftExecutionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkflowDraftExecutionScalarFieldEnumSchema, WorkflowDraftExecutionScalarFieldEnumSchema.array()]).optional() }).strict();