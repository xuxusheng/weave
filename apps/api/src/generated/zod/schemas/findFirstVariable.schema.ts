...
export const VariableFindFirstSelectSchema: z.ZodType<Prisma.VariableSelect> = z.object({
...
export const VariableFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    namespaceId: z.boolean().optional(),
    key: z.boolean().optional(),
    value: z.boolean().optional(),
...
export const VariableFindFirstSchema: z.ZodType<Prisma.VariableFindFirstArgs> = z.object({ select: VariableFindFirstSelectSchema.optional(),  orderBy: z.union([VariableOrderByWithRelationInputObjectSchema, VariableOrderByWithRelationInputObjectSchema.array()]).optional(), where: VariableWhereInputObjectSchema.optional(), cursor: VariableWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VariableScalarFieldEnumSchema, VariableScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.VariableFindFirstArgs>;

export const VariableFindFirstZodSchema = z.object({ select: VariableFindFirstSelectSchema.optional(),  orderBy: z.union([VariableOrderByWithRelationInputObjectSchema, VariableOrderByWithRelationInputObjectSchema.array()]).optional(), where: VariableWhereInputObjectSchema.optional(), cursor: VariableWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VariableScalarFieldEnumSchema, VariableScalarFieldEnumSchema.array()]).optional() }).strict();